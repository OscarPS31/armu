...
The final dataset was validated with the following results:

- 0 null values
- 0 prices less than or equal to zero
- 0 duplicate rows
- minimum price: MXN 1.65
- maximum price: MXN 1,420.97
- correct columns
- final file size: approximately 0.149 MB
